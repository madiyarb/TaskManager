...
public class Delete : EndpointBaseAsync
    .WithRequest<DeleteProjectCommand>
    .WithActionResult<DefaultResponseObject<string>>
{
    ...
    public override async Task<ActionResult<DefaultResponseObject<string>>> HandleAsync([FromBody]DeleteProjectCommand request, CancellationToken cancellationToken = new CancellationToken())
    {
